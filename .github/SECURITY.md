<!-- Read more about `SECURITY.md` [here](https://docs.github.com/en/code-security/getting-started/adding-a-security-policy-to-your-repository) -->
...
If you discover a security vulnerability related to this project, please report it by [opening a new Security Advisoriy on GitHub](/../../security/advisories/new). We will review the reports as soon as possible and will discuss the best plan of action, including the disclosure of the vulnerability to the public.
